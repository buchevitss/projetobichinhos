...
public class Cao{
		...
		public Cao(String nome, int idade,
				String cor, String vacina, String castrado, String comportamento,
				  String sexo,String porte, String raca, String endereco, int telefone) {
	...
	public void ficha(){
		...
		System.out.println("\nOlá! Seja bem vinde! Temos estes lindos Cãezinhos precisando de um lar");
